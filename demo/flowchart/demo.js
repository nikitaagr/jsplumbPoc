jsPlumb.ready(function () {
  ...
  instance.batch(function () {
    ...
    // connect a few up
    instance.connect({ uuids: ["Window5TopCenter", "Window6TopCenter"] });
    ...
    instance.bind("click", function (conn, originalEvent) {
      ...
      console.log("instance", conn + "" + originalEvent);
    });
    ...
    console.log("last", instance);
    console.log("lat123", JSON.parse(instance));
  });
